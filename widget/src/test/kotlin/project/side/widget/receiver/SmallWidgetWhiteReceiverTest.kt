...
class SmallWidgetWhiteReceiverTest {

    @Test
    fun `SmallWidgetWhiteReceiver는 GlanceAppWidgetReceiver를 상속한다`() {
        assertTrue(
            "SmallWidgetWhiteReceiver must extend GlanceAppWidgetReceiver",
            GlanceAppWidgetReceiver::class.java.isAssignableFrom(SmallWidgetWhiteReceiver::class.java),
        )
    }

    @Test
    fun `glanceAppWidget은 GlanceAppWidget 타입이어야 한다`() {
        val field = SmallWidgetWhiteReceiver::class.java
